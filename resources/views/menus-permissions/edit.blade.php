                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        @if($menuPermissions) 
                                            ...
                                            <input id="allPermissions" type="text" value="{{ $menuPermissions }}" />
</div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="switch">
                                                            ...
                                                            <input id="add_menu_{{ $menu->id }}" {{$menu->add_permission === 1 ? 'checked':''}} type="checkbox" value="{{ $menu->add_permission }}" onchange="handleChange(this);" @checked( $menu->add_permission == '1') />
                                                    ...
                                                    <td>
                                                        <label class="switch">
                                                            ...
                                                            <input id="edit_menu_{{ $menu->id }}" {{$menu->edit_permission === 1 ? 'checked':''}} type="checkbox" value="{{ $menu->edit_permission }}" onchange="handleChange(this);" @checked( $menu->edit_permission === 'true') />
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <label class="switch">
                                                            ...
                                                            <input id="delete_menu_{{ $menu->id }}" {{$menu->delete_permission === 1 ? 'checked':''}} type="checkbox" value="{{ $menu->delete_permission }}" onchange="handleChange(this);" @checked( $menu->delete_permission === 'true') />
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </td>
                                                    <td>
