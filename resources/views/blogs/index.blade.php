@extends('layout.app')
@section('title', 'LASIK Blogs')
@section('subtitle', 'List of Blogs')
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-bd ">
                ...
                <div class="panel-body">
                    <div class="text-right">
                        <a class="btn btn-exp btn-sm" data-toggle="modal" data-target="#addHoliday"><i class="fa fa-plus"></i> Add Blog</a>
                    </div>
